...
parser.add_argument("--loop", action="store_true", help="Repeat the stacked-box cycle until the viewer closes.")
    ...
    while running and simulation_app.is_running():
        ...
        for step in range(args_cli.num_steps):
            ...
            if step % 40 == 0 or step == args_cli.num_steps - 1:
                ...
                print(
                    f"[INFO]: cycle={cycle_count} step={step:03d} top_pos={top_pose[:3].cpu().tolist()} "
