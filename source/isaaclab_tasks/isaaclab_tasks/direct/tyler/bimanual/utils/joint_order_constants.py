...
assert (
    ...
    f"{len(CUROBO_JOINT_ORDER)}, {len(PYBULLET_JOINT_ORDER)}, {len(ISAACLAB_JOINT_ORDER)}, {len(FABRIC_JOINT_ORDER)}"
)
assert (
    ...
    f"{set(CUROBO_JOINT_ORDER)}, {set(PYBULLET_JOINT_ORDER)}, {set(ISAACLAB_JOINT_ORDER)}, {set(FABRIC_JOINT_ORDER)}"
)
