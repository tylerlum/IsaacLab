...
def quat_wxyz_to_axis_angle(quaternions: torch.Tensor) -> torch.Tensor:
    """
...
def matrix_to_axis_angle(matrix: torch.Tensor) -> torch.Tensor:
    ...
    Returns:
        Rotations given as a vector in axis angle form, as a tensor
            ...
            direction.
    """
    return quat_wxyz_to_axis_angle(matrix_to_quat_wxyz(matrix))
...
def quat_mul(q1: torch.Tensor, q2: torch.Tensor) -> torch.Tensor:
    """(q1 ∘ q2) with w x y z ordering, batch‑wise"""
