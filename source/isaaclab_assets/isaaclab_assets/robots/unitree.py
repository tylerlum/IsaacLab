...
G1_DEX3_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{ISAACLAB_ASSETS_DATA_DIR}/Robots/G1_urdf_to_usd/g1_29dof_with_hand_rev_1_0.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            "right_shoulder_roll_joint": -0.16,
            "right_shoulder_pitch_joint": 0.35,
            "left_hand_index_.*_joint": -1.0,
            "right_hand_index_.*_joint": 1.0,
            "left_hand_middle_.*_joint": -1.0,
            "right_hand_middle_.*_joint": 1.0,
            "left_hand_thumb_.*_joint": 1.0,
            "right_hand_thumb_.*_joint": -1.0,
        },
        joint_vel={".*": 0.0},
    ),
    soft_joint_pos_limit_factor=0.9,
